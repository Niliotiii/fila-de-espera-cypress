...
Cypress.Commands.add('TelasConsultasCrianca', (values) => {
  ...
  //   cy.get('body > div.relative.flex.min-h-screen.flex-col > div.flex-1 > div > div > main > div:nth-child(3) > div > div > form > div.-mb-10.ml-5.grid.grid-cols-10.items-start.justify-center.gap-7 > div.flex-rows.relative.flex.w-full.items-center.col-span-3.undefined > input')
  //     .type(values.responsavel2.nome);
  //   cy.wait(1000);
  //   cy.contains(values.responsavel2.nome).should('exist');
  //   cy.get('body > div.relative.flex.min-h-screen.flex-col > div.flex-1 > div > div > main > div:nth-child(3) > div > div > form > div.-mb-10.ml-5.grid.grid-cols-10.items-start.justify-center.gap-7 > div.flex-rows.relative.flex.w-full.items-center.col-span-3.undefined > input').clear();
  //   cy.wait(1000);
